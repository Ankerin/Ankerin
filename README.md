...
* Network stack design (TCP, UDP, QUIC)
* Custom memory allocators
* Shader programming (HLSL / GLSL / SPIR-V)
* Engine-level AI & physics systems
* CMake project architecture
* Reverse engineering & optimization
...
**AstroLune Core** — низкоуровневое ядро, разработанное на C++, обеспечивающее модульность, real-time взаимодействие и распределённую архитектуру.
